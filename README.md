...
We will be using AWS for highly scalable, available, reliable, and fast solution. To make our product more reliable we will to use blockchain so that the data is kept safe and transparent.
